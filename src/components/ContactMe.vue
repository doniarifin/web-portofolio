<template>
  <div class="w-full">
    ...
    <div ref="fadeElement" class="opacity-0 invisible">
      <h1 class="w-[80%] h-[100%] justify-center mx-[auto] lg:text-6xl text-justify md:text-6xl sm:text-6xl text-4xl text-gray-300 font-bold pt-10">Contact</h1>
      <div class="w-[80%] h-[100%] justify-center mx-[auto] hover:scale-105 transition duration-300 ease-in-out pb-10">
      ...
      (entries) => {
        entries.forEach(entry => {
          if (entry.isIntersecting) {
            ...
            fadeElement.value.classList.add('fadeInDown-animation');
